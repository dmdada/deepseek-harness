...
| `description` | Extra model-facing wording appended to the generated tool description, e.g. a cost or quality note that distinguishes this channel from a sibling instance. |
...
- **Child policy is fixed per instance** — another model, persona, tool filter, depth cap, or description requires another distinctly named tool.
