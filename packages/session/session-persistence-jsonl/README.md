...
- **No automatic retention** — `delete(id)` removes the addressed session's whole directory, and nothing else prunes logs; they accumulate under `root` until removed through the seam or externally.
