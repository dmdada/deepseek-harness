...
import {
  deriveArchivedSessions, deriveFlat, deriveGroups, deriveSearchResults, owningGroupKey, UNGROUPED_KEY,
} from '../tree.ts'
...
function FlatList({
  ...
  archivedSessionIds, onSessionUnarchive, onSessionDelete, usePanelInfo,
