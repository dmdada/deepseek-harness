...
| [`tool-image-vlm/`](tool-image-vlm/README.md) | Model-facing `image_understand` tool: sends a local image to a vision-language model relay and returns a textual description | registers on `ctx.tools` |
